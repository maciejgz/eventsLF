...
import pl.mg.eventlisting.NoSuchLocationException;
import pl.mg.eventlisting.model.Location;
import pl.mg.eventlisting.model.impl.LocationImpl;
import pl.mg.eventlisting.model.impl.LocationModelImpl;
...
public class LocationPersistenceImpl extends BasePersistenceImpl<Location>
    ...
    @Override
    public Location updateImpl(pl.mg.eventlisting.model.Location location)
        throws SystemException {
        location = toUnwrappedModel(location);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.pl.mg.eventlisting.model.Location")));
