...
public class LocationUtil {
    ...
    */
    public static java.util.List<pl.mg.eventlisting.model.Location> findByGroupId(
        long groupId)
    ...
    * @throws pl.mg.eventlisting.NoSuchLocationException if a matching location could not be found
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location findByGroupId_First(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchLocationException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location fetchByGroupId_First(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location findByGroupId_Last(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchLocationException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location fetchByGroupId_Last(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws pl.mg.eventlisting.NoSuchLocationException if a location with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location[] findByGroupId_PrevAndNext(
    ...
    */
    public static void cacheResult(pl.mg.eventlisting.model.Location location) {
    ...
    */
    public static void cacheResult(
        java.util.List<pl.mg.eventlisting.model.Location> locations) {
    ...
    */
    public static pl.mg.eventlisting.model.Location create(long locationId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location remove(long locationId)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchLocationException {
        return getPersistence().remove(locationId);
    }

    public static pl.mg.eventlisting.model.Location updateImpl(
    ...
    /**
    * Returns the location with the primary key or throws a {@link pl.mg.eventlisting.NoSuchLocationException} if it could not be found.
    *
    * @param locationId the primary key of the location
    * @return the location
    * @throws pl.mg.eventlisting.NoSuchLocationException if a location with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location findByPrimaryKey(
        long locationId)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchLocationException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Location fetchByPrimaryKey(
        long locationId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<pl.mg.eventlisting.model.Location> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static LocationPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (LocationPersistence) PortletBeanLocatorUtil.locate(pl.mg.eventlisting.service.ClpSerializer.getServletContextName(),
