...
import pl.mg.eventlisting.model.EventClp;
import pl.mg.eventlisting.model.LocationClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "EventListing-1.0.0-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "EventListing-1.0.0";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("pl.mg.eventlisting.model.impl.EventImpl")) {
        ...
        if (oldModelClassName.equals(
                    "pl.mg.eventlisting.model.impl.LocationImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("pl.mg.eventlisting.NoSuchEventException")) {
            return new pl.mg.eventlisting.NoSuchEventException();
        }

        if (className.equals("pl.mg.eventlisting.NoSuchLocationException")) {
            return new pl.mg.eventlisting.NoSuchLocationException();
        }
