...
public class EventUtil {
    ...
    */
    public static java.util.List<pl.mg.eventlisting.model.Event> findByGroupId(
        long groupId)
    ...
    * @throws pl.mg.eventlisting.NoSuchEventException if a matching event could not be found
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event findByGroupId_First(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchEventException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event fetchByGroupId_First(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event findByGroupId_Last(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchEventException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event fetchByGroupId_Last(
        long groupId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws pl.mg.eventlisting.NoSuchEventException if a event with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event[] findByGroupId_PrevAndNext(
    ...
    */
    public static void cacheResult(pl.mg.eventlisting.model.Event event) {
    ...
    */
    public static void cacheResult(
        java.util.List<pl.mg.eventlisting.model.Event> events) {
    ...
    */
    public static pl.mg.eventlisting.model.Event create(long eventId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event remove(long eventId)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchEventException {
        return getPersistence().remove(eventId);
    }

    public static pl.mg.eventlisting.model.Event updateImpl(
        pl.mg.eventlisting.model.Event event)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(event);
    }

    /**
    * Returns the event with the primary key or throws a {@link pl.mg.eventlisting.NoSuchEventException} if it could not be found.
    *
    * @param eventId the primary key of the event
    * @return the event
    * @throws pl.mg.eventlisting.NoSuchEventException if a event with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event findByPrimaryKey(long eventId)
        throws com.liferay.portal.kernel.exception.SystemException,
            pl.mg.eventlisting.NoSuchEventException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static pl.mg.eventlisting.model.Event fetchByPrimaryKey(long eventId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<pl.mg.eventlisting.model.Event> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static EventPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (EventPersistence) PortletBeanLocatorUtil.locate(pl.mg.eventlisting.service.ClpSerializer.getServletContextName(),
