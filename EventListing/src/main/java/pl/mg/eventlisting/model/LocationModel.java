 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link pl.mg.eventlisting.model.impl.LocationModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link pl.mg.eventlisting.model.impl.LocationImpl}.
 * </p>
 *
 * @author mg
 * @see Location
 * @see pl.mg.eventlisting.model.impl.LocationImpl
 * @see pl.mg.eventlisting.model.impl.LocationModelImpl
 * @generated
 */
public interface LocationModel extends BaseModel<Location> {
    ...
    @Override
    public CacheModel<pl.mg.eventlisting.model.Location> toCacheModel();
