 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link pl.mg.eventlisting.model.impl.EventModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link pl.mg.eventlisting.model.impl.EventImpl}.
 * </p>
 *
 * @author mg
 * @see Event
 * @see pl.mg.eventlisting.model.impl.EventImpl
 * @see pl.mg.eventlisting.model.impl.EventModelImpl
 * @generated
 */
public interface EventModel extends BaseModel<Event> {
    ...
    @Override
    public CacheModel<pl.mg.eventlisting.model.Event> toCacheModel();
