...
public class LocationWrapper implements Location, ModelWrapper<Location> {
    ...
    */
    ...
    @Override
    public int compareTo(pl.mg.eventlisting.model.Location location) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<pl.mg.eventlisting.model.Location> toCacheModel() {
        return _location.toCacheModel();
    }

    @Override
    public pl.mg.eventlisting.model.Location toEscapedModel() {
        return new LocationWrapper(_location.toEscapedModel());
    }

    @Override
    public pl.mg.eventlisting.model.Location toUnescapedModel() {
