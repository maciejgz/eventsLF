...
public class EventWrapper implements Event, ModelWrapper<Event> {
    ...
    */
    ...
    @Override
    public int compareTo(pl.mg.eventlisting.model.Event event) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<pl.mg.eventlisting.model.Event> toCacheModel() {
        return _event.toCacheModel();
    }

    @Override
    public pl.mg.eventlisting.model.Event toEscapedModel() {
        return new EventWrapper(_event.toEscapedModel());
    }

    @Override
    public pl.mg.eventlisting.model.Event toUnescapedModel() {
